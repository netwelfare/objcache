/* =========================================================================
 * File: $Id: $SynchronizedCacheTest.java,v$
 *
...
/**
 * Класс BlockingCacheTest тестирует SynchronizedCache
 *
...
// ----------------------------------------------------------------------------- Public методы
    ...
    /**
     * Устанавливаем максимальное количество элементов в кеше. Помещаем больше чем установили.
     * Результатом должно быть максимальное количество объектов.
     */
