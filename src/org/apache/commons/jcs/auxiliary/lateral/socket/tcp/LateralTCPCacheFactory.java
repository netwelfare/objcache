 ...
 * 这个类主要有三个功能：createCache，createListener，createDiscoveryService
 * 
 */
public class LateralTCPCacheFactory extends LateralCacheAbstractFactory
{
			...
			ICacheEventLogger cacheEventLogger, IElementSerializer elementSerializer)
	{
		...
		LateralCacheNoWaitFacade<K, V> lcnwf = new LateralCacheNoWaitFacade<K, V>(listener, lcnwArray,
	 ...
	 */
	@Override
	public <K, V> ILateralCacheListener<K, V> createListener(ILateralCacheAttributes lac,
	 ...
	 */
	private synchronized <K, V> UDPDiscoveryService createDiscoveryService(ITCPLateralCacheAttributes lac,
			LateralCacheNoWaitFacade<K, V> lcnwf, ICompositeCacheManager cacheMgr, ICacheEventLogger cacheEventLogger,
			IElementSerializer elementSerializer)
	{
		...
		if (lac.isUdpDiscoveryEnabled())
		{
			...
			LateralTCPDiscoveryListener discoveryListener = lateralTCPDiscoveryListenerManager.getDiscoveryListener(lac,
			...
			discovery = UDPDiscoveryManager.getInstance().getService(lac.getUdpDiscoveryAddr(),
					lac.getUdpDiscoveryPort(), lac.getTcpListenerPort(), cacheMgr);
